...
<html lang="en" class="no-js">
  <head>
    ...
    <title>Reza Mandala | Web Developer</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
    <meta name="description" content="Reza Mandala | Web Developer" />
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/css/bootstrap-grid.min.css" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/css/animations.css" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/css/perfect-scrollbar.css" type="text/css">
  ...
  <body>
          ...
          <header id="site_header" class="header mobile-menu-hide">
            <div class="header-content">
              <div class="header-photo">
                <img src="<?php echo base_url() ?>assets/img/main_photo.jpg" alt="Alex Smith">
              </div>
                      ...
                      <div class="info-list">
                        <ul>
                          ...
                          <li>
                            ...
                            <span class="value">Sukoharjo</span>
                          </li>

                          <li>
                            <span class="title">Address</span>
                            <span class="value">Grogol, Sukoharjo</span>
                          </li>

                          <li>
                            <span class="title">e-mail</span>
                            <span class="value">contactrezamandala@gmail.com</span>
                          </li>

                          <li>
                            <span class="title">Phone</span>
                            <span class="value">+62-899-535-XXXX</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12">
                      <div class="testimonials owl-carousel">
                        ...
                        <div class="testimonial">
                          <div class="img">
                            <img src="<?php echo base_url() ?>assets/img/testimonials/testimonial-1.jpg" alt="Alex Smith">
                          </div>
                          <div class="text">
                        ...
                        <div class="testimonial">
                          <div class="img">
                            <img src="<?php echo base_url() ?>assets/img/testimonials/testimonial-2.jpg" alt="Alex Smith">
                          </div>
                          <div class="text">
                            <p>Vivamus at molestie dui, eu ornare orci. Curabitur vel egestas dolor. Nulla condimentum nunc sit amet urna tempus finibus. Duis mollis leo id ligula pellentesque, at vehicula dui ultrices.</p>
                          </div>
                        ...
                        <div class="testimonial">
                          <div class="img">
                            <img src="<?php echo base_url() ?>assets/img/testimonials/testimonial-3.jpg" alt="Alex Smith">
                          </div>
                          <div class="text">
                            <p>Vivamus at molestie dui, eu ornare orci. Curabitur vel egestas dolor. Nulla condimentum nunc sit amet urna tempus finibus. Duis mollis leo id ligula pellentesque, at vehicula dui ultrices.</p>
                          </div>
                      ...
                      <div class="clients owl-carousel">
                        ...
                        <div class="client-block">
                          <a href="#" target="_blank" title="Logo">
                            <img src="<?php echo base_url() ?>assets/img/clients/client-1.png" alt="Logo">
                          </a>
                        </div>

                        <div class="client-block">
                          <a href="#" target="_blank" title="Logo">
                            <img src="<?php echo base_url() ?>assets/img/clients/client-2.png" alt="Logo">
                          </a>
                        </div>

                        <div class="client-block">
                          <a href="#" target="_blank" title="Logo">
                            <img src="<?php echo base_url() ?>assets/img/clients/client-3.png" alt="Logo">
                          </a>
                        </div>

                        <div class="client-block">
                          <a href="#" target="_blank" title="Logo">
                            <img src="<?php echo base_url() ?>assets/img/clients/client-4.png" alt="Logo">
                          </a>
                        </div>

                        <div class="client-block">
                          <a href="#" target="_blank" title="Logo">
                            <img src="<?php echo base_url() ?>assets/img/clients/client-5.png" alt="Logo">
                          </a>
                        </div>

                        <div class="client-block">
                          <a href="#" target="_blank" title="Logo">
                            <img src="<?php echo base_url() ?>assets/img/clients/client-6.png" alt="Logo">
                          </a>
                        </div>

                        <div class="client-block">
                          <a href="#" target="_blank" title="Logo">
                            <img src="<?php echo base_url() ?>assets/img/clients/client-7.png" alt="Logo">
                          </a>
                        </div>
                        ...
                        <div class="portfolio-grid three-columns">
                          ...
                          <figure class="item lbaudio" data-groups='["category_all", "category_soundcloud"]'>
                            <div class="portfolio-item-img">
                              <img src="<?php echo base_url() ?>assets/img/portfolio/1.jpg" alt="SoundCloud Audio" title="" />
                          ...
                          <figure class="item standard" data-groups='["category_all", "category_detailed"]'>
                            <div class="portfolio-item-img">
                              <img src="<?php echo base_url() ?>assets/img/portfolio/2.jpg" alt="Media Project 2" title="" />
                          ...
                          <figure class="item lbvideo" data-groups='["category_all", "category_vimeo-videos"]'>
                            <div class="portfolio-item-img">
                              <img src="<?php echo base_url() ?>assets/img/portfolio/3.jpg" alt="Vimeo Video 1" title="" />
                          ...
                          <figure class="item standard" data-groups='["category_all", "category_detailed"]'>
                            <div class="portfolio-item-img">
                              <img src="<?php echo base_url() ?>assets/img/portfolio/4.jpg" alt="Media Project 1" title="" />
                              <a href="portfolio-1.html" class="ajax-page-load"></a>
                            </div>
                          ...
                          <figure class="item lbimage" data-groups='["category_all", "category_mockups"]'>
                            <div class="portfolio-item-img">
                              <img src="<?php echo base_url() ?>assets/img/portfolio/5.jpg" alt="Mockup Design 1" title="" />
                          ...
                          <figure class="item lbvideo" data-groups='["category_all", "category_youtube-videos"]'>
                            <div class="portfolio-item-img">
                              <img src="<?php echo base_url() ?>assets/img/portfolio/6.jpg" alt="YouTube Video 1" title="" />
                          ...
                          <div class="blog-card">
                            <div class="media-block">
                              ...
                              <a href="blog-post-1.html">
                                <img src="<?php echo base_url() ?>assets/img/blog/blog_post_1.jpg" class="size-blog-masonry-image-two-c" alt="Why I Switched to Sketch For UI Design" title="" />
                                <div class="mask"></div>
                              </a>
                            </div>
                            <div class="post-info">
                        ...
                        <div class="item post-2">
                          <div class="blog-card">
                            <div class="media-block">
                              ...
                              <a href="blog-post-1.html">
                                <img src="<?php echo base_url() ?>assets/img/blog/blog_post_2.jpg" class="size-blog-masonry-image-two-c" alt="Best Practices for Animated Progress Indicators" title="" />
                                <div class="mask"></div>
                              </a>
                            </div>
                            <div class="post-info">
                        ...
                        <div class="item post-1">
                          <div class="blog-card">
                            <div class="media-block">
                              ...
                              <a href="blog-post-1.html">
                                <img src="<?php echo base_url() ?>assets/img/blog/blog_post_3.jpg" class="size-blog-masonry-image-two-c" alt="Designing the Perfect Feature Comparison Table" title="" />
                                <div class="mask"></div>
                              </a>
                            </div>
                            <div class="post-info">
                        ...
                        <div class="item post-2">
                          <div class="blog-card">
                            <div class="media-block">
                              ...
                              <a href="blog-post-1.html">
                                <img src="<?php echo base_url() ?>assets/img/blog/blog_post_4.jpg" class="size-blog-masonry-image-two-c" alt="An Overview of E-Commerce Platforms" title="" />
                                <div class="mask"></div>
                              </a>
                            </div>
                            <div class="post-info">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4">
                      ...
                      <div class="lm-info-block gray-default">
                        ...
                        <h4>contactrezamandala @gmail.com</h4>
                        <span class="lm-info-block-value"></span>
                        <span class="lm-info-block-text"></span>
                      </div>
    ...
    <script src="<?php echo base_url() ?>assets/js/modernizr.custom.js"></script>
    <script src="<?php echo base_url() ?>assets/js/animating.js"></script>
    ...
    <script src="<?php echo base_url() ?>assets/js/jquery.googlemap.js"></script>
